...
public class ConstantUtils
{
    ...
    public static String propertyFilePath = "/Users/chethanc/Documents/ChethanProject/MyJavaAutomation/src/test/drivers/chromedriver";
    public static String chromeProperties = "webdriver.chrome.driver";
